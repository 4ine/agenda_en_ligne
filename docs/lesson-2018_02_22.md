...
- [`prepare()` préparer la requête](http://php.net/manual/fr/pdo.prepare.php)
- [`bindParam()` lie un paramètre à un nom de variable spécifique.](http://php.net/manual/fr/pdostatement.bindparam.php)
